...
// // //             rowKey="id"
// // //             pagination={false}
// // //             rowClassName={(record) => record.stock < record.minimumquantity ? 'bg-red-100' : ''}
// // //           />
...
// // //               Save Order
// // //             </Button>
// // //             <Button onClick={printOrder} disabled={!orderGenerated}>
// // //               Print Order
// // //             </Button>
// // //           </Space>
// // //         </>
...
// //     const tableColumn = ["Item Name", "Required Quantity", "Trade Price", "Total Price"];
// //     const filteredItems = items.filter(item => item.orderQuantity > 0); // Only include items with orderQuantity > 0
...
// //               option.children.toLowerCase().indexOf(input.toLowerCase()) >= 0 // Filter based on input
// //             }
// //           >
// //             {distributors.map(distributor => (
// //               <Option key={distributor.id} value={distributor.id}>{distributor.name}</Option>
...
//   return (
//     <Card style={{ maxWidth: 1200, margin: 'auto', padding: '0px' }}>
...
//       {orderGenerated && (
//         <>
//           <div style={{ maxHeight: 240, overflowY: 'auto', marginBottom: '0px' }}>
//             <Table
//               dataSource={items}
//               columns={columns}
//               rowKey="id"
