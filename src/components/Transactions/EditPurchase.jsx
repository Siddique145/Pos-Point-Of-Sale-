...
// // export default function EditPurchaseInvoice({ onClose }) {
...
// //             (invoice) => invoice.date && invoice.date.toDate
// //           );

// //           setRecentInvoices(
// //             validInvoices.sort((a, b) => b.date.toDate() - a.date.toDate())
// //           );
// //         }
// //       );
...
// //         const { date, items, invoiceNumber, distributorId } =
// //           invoiceData.data();
// //         form.setFieldsValue({
...
// //             const newStock = currentStock + (item.packQty || 0);
...
// //       ((item.unitQty || 0) * (item.tradePrice || 0)) / (item.packQuantity || 1);
...
// //           newItem.packQty += Math.floor(totalUnits / (newItem.packQty || 1));
...
// //         <InputNumber
// //           value={record.gst}
// //           onChange={(value) => handleQuantityChange(record.key, "gst", value)}
// //           style={{ width: 100 }}
// //         />
// //       ),
// //     },
...
// //           onChange={(value) =>
// //             handleQuantityChange(record.key, "totalAmount", value)
// //           }
// //           style={{ width: 100 }}
// //         />
// //       ),
